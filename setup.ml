...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee617002ddfcad1ac06b326b7859ee51) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://mjambon.com/cppo.html";
          ...
          description =
            Some
              [
                 ...
                 OASISText.Para
                   "The main purpose of cppo is to provide a lightweight tool for simple macro substitution ( occasional case when this is useful in OCaml. Processing specific sections of files by calling external programs is also possible via";
                 OASISText.Para
          ...
          clean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("$rm", ["test/*.out"])))]
            };
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
          ...
          files_ab = ["cppo_version.ml.ab"];
          sections =
            [
               Library
                 ({
                     cs_name = "ocamlbuild_cppo";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cppo_main.ml"});
               Executable
                 ({
                     cs_name = "diff";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "diff.ml"});
               Test
                 ({
                     cs_name = "ext";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mjambon/cppo.git";
                      src_repo_browser =
                        Some "https://github.com/mjambon/cppo";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\138w\240\r\133\206*J\012T\132A\174\186>R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
